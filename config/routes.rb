BackchannelApplication::Application.routes.draw do
  ...
  match "users/logout" => "users#logout", :as => "log_out"

  match "users/login" => "users#login"

  match "votes/update" => "votes#update_votes"

  match "post/search" => "posts#search"

  match "users/admin" => "users#admin"

  match "users/grant" => "users#grant"

  match "users/revoke" => "users#revoke"

  match "posts/activity" => "posts#activity"
